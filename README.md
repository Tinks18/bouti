...
Celtic Tiles is the online store of a small business based in the West of Ireland, specialising in live poultry. The store offers a variety of laying hens, broiler chickens and laying ducks. Currently the business offers in-store collection of orders only with a limited range of hoome delivery planned for the future.
On their site, Celtic Tiles also host a forum about all things poultry. Articles published by the business itself are posted on a regular basis, offering helpful advice about poultry keeping, interesting facts about different breeds or the latest recommendations on feeds, bedding, pest control, etc.

![responsive mockup](/media/readme/mockup.png)

[Link to live site](https://celtic-tiles.herokuapp.com/) 
...
This site is the online shop of the fictional supplier of live poultry "Celtic Tiles". This business is based in county Clare, Ireland and is aiming to cover a customer base in the whole mid-western region of Ireland. Mainly counties Limerick, Clare and Galway.
...
![Blog page](/media/readme/features/forum.png)
...
![blog entry](/media/readme/features/forum-entry.png)
...
![Blog results](/media/readme/validation/html-forum.png)
